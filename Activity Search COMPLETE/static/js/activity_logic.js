  ...
  function createFeatures(activityData) {
    ...
    let orangeIcon = L.divIcon({
      ...
      html: `<div class="icon-wrapper"><i class="fas fa-map-marker" style="color: #C56C39; font-size: 3em;"></i><div class="circle" 
        style="position: absolute; top: 9%; left: 14%; transform: translate(-0%, -0%); width: 13px; height: 13px; background-color: white; border-radius: 50%; border: 1px solid #9d4d1f; box-shadow: 0px 0px 5px rgba(244, 204, 181, 0.5); z-index: 1000;"></div></div>`,
      iconSize: [48, 64],
      iconAnchor: [24, 50],
      popupAnchor: [0, -42],
    });
