...
function createFeatures(activityData) {
  ...
  // Define a new function to update the map with filtered data
    ...
    let filteredParks = L.geoJSON(filteredGeojsonFeatures, {
      ...
      onEachFeature: function (feature, layer) {
        ...
        layer.on('mouseover', function () {
          updateTooltipContent(layer, feature);
          layer.openPopup(); // Use openPopup() instead of openTooltip()
        });

        // Close popup on mouseout
        layer.on('mouseout', function () {
          layer.closePopup(); // Use closePopup() instead of closeTooltip()
        });
      }
    });
